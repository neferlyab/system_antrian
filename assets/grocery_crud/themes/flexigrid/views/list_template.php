...
<div id='list-report-error' class='report-div error alert alert-error'></div>
<div id='list-report-success' class='report-div alert alert-success callout callout-info col-sm-6' <?php if($success_message !== null){?>style="display:block"<?php }?>> <?php
...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="tDiv">
		...
		<div class="tDiv2">
			...
			<div class=" btn btn-primary btn-flat btn-sm" style="font-family:arial">
				<div>
					<span class="fa fa-plus-circle"></span>&nbsp;<?php echo $this->l('list_add'); ?> <?php echo $subject?>
				</div>
			</div>
            </a>
	...
	<div class="sDiv quickSearchBox" id='quickSearchBox'>
		<div class="sDiv2">
			<?php echo $this->l('list_search');?>: <input type="text" class="qsbsearch_fieldox input-sm search_text" name="search_text" size="30" id='search_text'>
            ...
            <button type="button" value="" class="crud_search btn btn-white btn-primary btn-round btn-sm" id='crud_search'><i class='ace-icon fa fa-search yellow'></i> <?php echo $this->l('list_search');?></button>
		</div>
        <div class='search-div-clear-button'>
        	<button type="button" value="" id='search_clear' class="search_clear btn btn-white btn-default btn-round btn-xs"><i class="ace-icon fa fa-times red2"></i> <?php echo $this->l('list_clear_filtering');?> </button>
        </div>
	</div>
	<div class="pDiv">
		<div class="pDiv2">
			<div class="pGroup">
				<span class="pcontrol">
					...
					<select name="per_page" id='per_page' class="per_page input-sm">
			...
			<div class="pGroup">
				<span class="pcontrol"><?php echo $this->l('list_page'); ?> <input name='page' type="text" value="1" size="4" id='crud_page' class="crud_page input-sm">
